...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO MY-AnggA SCRIPT ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
echo -e "    SABAR LAGI CEK IZIN VPS MU !!"
echo -e " ›AUTHOR : ${green}MY-AnggA® ${NC}${YELLOW}(${NC}${green}V 3.2${NC}${YELLOW})${NC}"
echo -e " ›TEAM 🅥🅝: LandeanVPN ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
data_ip="https://www.anggaalfarizi.tips/data.txt"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      ${GREEN}TELEGRAM${NC} t.me/anggaalfarizi"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit 0
  fi
}
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/landeanv/hehe/main/"
...
clear
izinsc="https://www.anggaalfarizi.tips/data.txt"
# USERNAME
rm -f /usr/bin/user
...
TIMES="10"
CHATID="-5196612474"
KEY="6756964255:AAGnk05frkWtST6M6ItDO7LZxs0TW_7tLYs"
...
wget -q https://raw.githubusercontent.com/landeanv/hehe/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
